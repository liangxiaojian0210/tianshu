...
| [0037](./0037-gold-concurrency-equivalence.md) | 金标准并发等价：fan-in 每源一线程驱动 | compiler | ✅ | 裁定「对比的前提是等价」、gold join 手写同步（锁序 j1→j2→sink）、线程化尾巴解读、p50 反转 compiled 快 11.7× |
| [0033](./0033-typed-source-entry.md) | 类型化源入口：入口段特化与判决口径统一 | dsl | ✅ | 宿主侧 SourceEntry、FanBinding 同构冻结、录制回落、历史收窄、协议 v2 线程预热 |
| [0038](./0038-h3-verification-semantics.md) | H3 验证语义：两轮预测力协议与漂移比对自动化 | sla | ✅ | 每 stage p99.9 验证单位、A 标定→B 验证（硬门 1.3×A_med + ε≤10% 环境判据）、确定性自旋 rig、--wcet rc 契约 0/2/3 |
...
- **dsl/compiler**：0001 · 0021 · 0024 · 0025 · 0026 · 0027 · 0028 · 0029 · 0030 · 0031 · 0032 · 0033 · 0034 · 0035 · 0036 · 0037 · 0038
- **gpu**：0006
